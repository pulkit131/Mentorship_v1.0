  ...
  return (
    <section id="contact">
      <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-t from-blue-200 to-white px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-[1200px] text-center mt-10 sm:mt-16 md:mt-[120px] md:w-[1200px]">
          <h1 className="text-[28px] sm:text-[32px] md:text-[40px] lg:text-[44px] font-semibold text-black mb-3 leading-tight w-full mx-auto md:w-[801px]">
            Connect with Industry-Proven Mentors
          </h1>
          <p className="text-[#0018A8] text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-normal w-full">
